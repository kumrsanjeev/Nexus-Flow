...
def make_image(prompt):
    """Generate image using HF model with retries"""
...
if prompt := st.chat_input("Message Nexus..."):
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            sys_msg = (
                "You are Nexus 🤖, a friendly ChatGPT-style assistant. "
                "Answer logically, use emojis naturally, and if the user wants an image, only respond with [GENERATE_IMAGE: prompt]. "
